...
import {PlayAnimation, AnimationPlayRefreshEnd, AnimationPlayRefreshBegin} from '../../PlayAnimation.js'; 
class  PlayRefresh extends Component {
    ...
    handleClick(event) {
       ...
       if(delayTime>0){
        setTimeout(() => AnimationPlayRefreshEnd(this.playID,this.refreshID), delayTime);
       }
    }
