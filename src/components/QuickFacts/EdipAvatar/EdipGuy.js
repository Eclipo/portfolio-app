                                  ...
                                  <div className="steam-container mx-auto">
                                      <div className="squiggle-container squiggle-container-1">
                                          <div className="squiggle ">
                                              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28.1 80.6"><path id='steamOneID' className="steamPath steamPath_one" d="M22.6 75.1c-8-5.6-15.2-10.5-15.2-19.9 0-12.1 14.1-17.2 14.1-29.6 0-9.1-6.7-15.7-16-20.1" /></svg>
                                          </div> 
                                      </div>
                              
                                  <div className="squiggle-container squiggle-container-2">
                                      <div className="squiggle">
                                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28.1 80.6"><path id='steamTwoID' className="steamPath steamPath_two" d="M22.6 75.1c-8-5.6-15.2-10.5-15.2-19.9 0-12.1 14.1-17.2 14.1-29.6 0-9.1-6.7-15.7-16-20.1"/></svg>
                                      </div>
                                  </div>

                                  <div className="squiggle-container squiggle-container-3">
                                      <div className="squiggle">
                                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28.1 80.6"><path id='steamThreeID' className="steamPath steamPath_three" d="M22.6 75.1c-8-5.6-15.2-10.5-15.2-19.9 0-12.1 14.1-17.2 14.1-29.6 0-9.1-6.7-15.7-16-20.1"/></svg>
                                      </div> 
                                  </div>
                                  </div>
                              </tr>
