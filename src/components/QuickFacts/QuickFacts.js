  ...
  return (
    <div id="quickFacts" className="sectionAnimation">
      <div
        ...
        style={{ backgroundColor: "var(--primary-yellow)" }}></div>
      <div className="container d-block">
        ...
        <div
          ...
          style={{ maxWidth: "45rem", marginTop: "-3rem" }}>
          <div className="row m-auto m-1">
            <div className="col m-1">
              <div className="quickCard">
                <span className="circ"></span>
                <h4 className="quickH4" style={{ marginTop: "-6rem" }}>
                  WEB<br></br>DEVELOPER
                </h4>
              </div>
            </div>
            ...
            <div className="col m-1">
              <div className="quickCard">
                <span className="circ"></span>
                <h4 className=" quickH4" style={{ marginTop: "-5rem" }}>
                  FAMILY
                </h4>
              </div>
            </div>
          ...
          <div className="row m-auto m-1"></div>
        </div>
      </div>
    </div>
  );
