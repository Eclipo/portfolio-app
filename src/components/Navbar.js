        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav pb-3 pt-3 mt-2">
            <li className="nav-item active">
              <Link smooth={true} to={"introSectionID"} className="nav-link" href="#">HOME<span className="sr-only">(current)</span></Link>
            </li>
            ...
            <li className="nav-item">
            <Link smooth={true} to={"portfolioID"} className="nav-link" href="#">Portfolio</Link>
            </li>
